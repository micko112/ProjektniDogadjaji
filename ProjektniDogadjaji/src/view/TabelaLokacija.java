...
public class TabelaLokacija extends javax.swing.JDialog {
    ...
    public TabelaLokacija(java.awt.Frame parent, boolean modal, String action) {//action znaci da li hocemo izmeni ili obrisi, prilicno jednostavan nacin
        ...
        LokacijaTableModel tm = new LokacijaTableModel(controller.UcitajLokacijeIzBaze());
        jTable.setModel(tm);
    ...
    private void jButtonIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIzmeniActionPerformed
        ...
        LokacijaTableModel model = (LokacijaTableModel) jTable.getModel();
        Lokacija lokacijaZaIzmenu = model.getLokacijaAt(selektovanRed);
    ...
    private void jButtonObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonObrisiActionPerformed
            ...
            if(selektovanaLokacija == -1){
                 ...
                 LokacijaTableModel model = (LokacijaTableModel) jTable.getModel();
        Lokacija lok = model.getLokacijaAt(selektovanaLokacija);
    ...
    private void jButtonPretragaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPretragaActionPerformed
        ...
        LokacijaTableModel tm = new LokacijaTableModel(filtriranaLokacija);
        jTable.setModel(tm);
